...
class AppStateData {
  ...
  AppStateData copyWith({
    String? language,
    Object? userId = const _Undefined(),
    Object? idToken = const _Undefined(),
    ZenLocalizationService? localization,
  }) => AppStateData(
    language: language ?? this.language,
    userId: userId is _Undefined ? this.userId : userId as String?,
    idToken: idToken is _Undefined ? this.idToken : idToken as String?,
    localization: localization ?? this.localization,
  );
}

/// Sentinel value to distinguish null from undefined.
class _Undefined {
  const _Undefined();
}
